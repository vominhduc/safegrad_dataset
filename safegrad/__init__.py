...
Repository layout
-----------------
  safegrad/pipeline/    — Four-stage ASL construction pipeline (Section 4)
  safegrad/eval/        — Evaluation suite (Section 5)
  safegrad/scripts/     — Utility scripts (pipeline runner, metadata export)
"""
